      ...
      <div className="mx-auto max-w-4xl space-y-16">
        {PROJECTS.map((project, idx) => (
          ...
          >
            ...
            <motion.h2
              variants={fadeUp}
              className="mb-5 text-2xl tracking-tight text-stone-900 sm:text-3xl"
            >
              {project.title}
            </motion.h2>
            ...
            {project.github && (
              <motion.div variants={fadeUp} className="mt-6">
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-[#0E5A6B] bg-white px-4 py-2 text-sm font-medium text-[#0E5A6B] transition-all hover:bg-[#0E5A6B] hover:text-white hover:shadow-md"
                >
